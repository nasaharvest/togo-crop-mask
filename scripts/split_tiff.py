...
if __name__ == "__main__":
    ...
    images = Path("../data/raw/big_earth_engine_region").glob("*.tif")
    output_folder = Path("../data/raw/earth_engine_region")
    for idx, image in enumerate(images):
        ...
        new_filename = f"{idx}-{name}_{start_date}_{end_date}"
